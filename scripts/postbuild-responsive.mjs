...
<style id="responsive-v2">
  ...
  @media (min-width:981px){
    ...
    .tagline{font-size:clamp(30px,3vw,36px)!important}
  ...
  @media (max-width:980px) and (min-width:761px){
    ...
    .tagline{font-size:clamp(27px,3.5vw,32px)!important}
...
if (html.includes('id="responsive-v2"')) {
